...
noncomputable def projectiveOperators {n outcomes : ℕ} (u : Fin outcomes → Vector n)
    : Fin outcomes → Square n :=
...
-/
noncomputable def projectiveRestoreOp {n : ℕ} (u : Fin n → Vector n) (i : Fin n)
    : Square n :=
  u i ⬝ (Vector.basis i)†
...
noncomputable def prob (M : Projective n outcomes) (s : Vector n) (m : Fin outcomes)
    : ℝ :=
...
noncomputable def postMeasure
    (M : Projective n outcomes) (s : Vector n) (m : Fin outcomes)
    : Vector n :=
...
@[simp]
theorem prob_eq_projProb (M : Projective n outcomes) (s : Vector n) (m : Fin outcomes)
...
theorem operator_mul_postMeasure (M : Projective n outcomes) (s : Vector n)
    (m : Fin outcomes)
